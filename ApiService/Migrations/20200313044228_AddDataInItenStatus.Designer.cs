...
namespace ApiService.Migrations
{
    ...
    [Migration("20200313044228_AddDataInItenStatus")]
    partial class AddDataInItenStatus
    {
            ...
            modelBuilder.Entity("Entities.DbModels.Factory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ae2e825f-997c-4384-a77d-5b0a579813ab",
                            CreatedDateTime = new DateTime(2020, 3, 13, 10, 42, 25, 949, DateTimeKind.Local).AddTicks(6777),
                            FactoryId = "54569290-52f7-4544-827d-9e1132a96565",
                            ImageUrl = "",
                            LicenseNo = "",
                            Name = "Fazlu Loom Factory",
                            RegNo = "",
                            RowStatus = "ADDED",
                            SubscriptionEnd = new DateTime(2022, 12, 8, 10, 42, 25, 951, DateTimeKind.Local).AddTicks(1039),
                            SubscriptionStart = new DateTime(2020, 3, 13, 10, 42, 25, 950, DateTimeKind.Local).AddTicks(4023),
                            UniqueId = 0L,
                            UpdatedDateTime = new DateTime(2020, 3, 13, 10, 42, 25, 951, DateTimeKind.Local).AddTicks(2989),
                            VatRegNo = ""
                        });
                });
            ...
            modelBuilder.Entity("Entities.DbModels.ItemStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7730c5a0-2a7d-49af-97ac-1f299c987c44",
                            CreatedDateTime = new DateTime(2020, 3, 13, 4, 42, 25, 988, DateTimeKind.Utc).AddTicks(4884),
                            FactoryId = "c90a9cdf-ca6b-4f74-b9f6-d00cd37b1b30",
                            Name = "GOOD",
                            RowStatus = "ADDED",
                            UniqueId = 0L,
                            UpdatedDateTime = new DateTime(2020, 3, 13, 4, 42, 25, 988, DateTimeKind.Utc).AddTicks(6584)
                        },
                        new
                        {
                            Id = "a531b24c-1719-4d22-ad17-b99464cba94b",
                            CreatedDateTime = new DateTime(2020, 3, 13, 4, 42, 25, 988, DateTimeKind.Utc).AddTicks(6625),
                            FactoryId = "c90a9cdf-ca6b-4f74-b9f6-d00cd37b1b30",
                            Name = "BAD",
                            RowStatus = "ADDED",
                            UniqueId = 0L,
                            UpdatedDateTime = new DateTime(2020, 3, 13, 4, 42, 25, 988, DateTimeKind.Utc).AddTicks(6662)
                        });
                });
